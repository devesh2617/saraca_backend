...
exports["default"] = (0, express_async_handler_1["default"])(function (req, _, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, error_1, decoded, user, error_2, error;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                if (!token) {
                    error_1 = new Error("unauthorized");
                    error_1.status = 401;
            ...
            case 2:
                user = _c.sent();
                if (!user) {
                    error_2 = new Error("User not found");
                    error_2.status = 401;
                ...
                error = new Error("Only TA admin can access this");
                error.status = 401;
